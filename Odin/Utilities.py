"""
Utilities.py v 0.7.0
    Dennis A. Simpson
    May 21, 2019
    Refactored based on pylint.  Not sure CountingGenerator is required.
...
def family_counts(region, ctg, family_dict, previous_exon_end, targeted_counts, index):
    ...
    :param ctg:
    :param family_dict:
    :param previous_exon_end:
    :param targeted_counts:
    :param index:
    :return:
    """
...
class FamilyDistribution:
    ...
    def data_processing(self):
        ...
        """
        self.log.info("Begin Family Size and UMT Analysis")
        ...
        self.log.info("{0} {1} UMT Family Size and Stats Files Written".format(self._args.JobName, self._data_source))
...
def byte_array_to_string(value):
    """
    Old code for python 2 compatibility
    :param value:
    :return:
    """
